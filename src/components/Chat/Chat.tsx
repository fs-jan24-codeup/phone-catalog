...
export const Chat = () => {
  ...
  return (
    <div>
      <button className={`open-chat ${isChatOpen ? 'open' : ''}`} onClick={() => setIsChatOpen(!isChatOpen)}>
